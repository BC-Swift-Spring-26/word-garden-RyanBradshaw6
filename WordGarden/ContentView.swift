...
//  WordGarden
//
//  Created by Ryan Bradshaw on 2/9/26.
//
        ...
        VStack {
            ...
            if playAgainHidden {
                ...
                Button(playAgainButtonLabel){
                    ...
                    gameStatusMessage = "How Many Guesses to Unconver the Hidden Word?"
            ...
            Image(imageName)
                .resizable()
                .scaledToFit()
                .animation(.easeInOut(duration: 0.750), value: imageName)
        }
